...
plot(graphdata$DateTime, graphdata$Sub_metering_1, type = "l", ylim = yrange, ylab = "Energy sub metering")
lines(graphdata$DateTime, graphdata$Sub_metering_2, type = "l", ylim = yrange, ylab = "Energy sub metering", col="red")
lines(graphdata$DateTime, graphdata$Sub_metering_3, type = "l", ylim = yrange, ylab = "Energy sub metering", col="blue")
